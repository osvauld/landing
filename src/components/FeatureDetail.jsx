...
export const FeatureDetail = () => (
  ...
  >
    <div className="bg-cardBg feature-card  w-full p-10 flex flex-col md:flex-row justify-between gap-10">
      <div className="flex-1">
        ...
        <p className="text-faqAnswer font-Inter text-base font-light">
          ...
          online, your data automatically syncs across all your devices. <br />{" "}
          <br /> It’s like having a personal notebook that’s always with you and
    ...
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ duration: 0.3, delay: 0.4 }}
      className="bg-cardBg feature-card  w-full p-10 flex flex-col md:flex-row justify-between gap-10"
    >
      <div className="bg-white2 flex-1 min-h-[250px]"></div>
      <div className="flex-1">
        <h3 className="gradient-text-bottom text-3xl lg:text-5xl font-Jakartha font-medium lg:leading-tight mb-8">
        ...
        <p className="text-faqAnswer font-Inter text-base font-light">
          Your data is safeguarded with top-tier encryption, ensuring everything
          stays secure and private. Imagine having a digital vault that only you
          can open - we make sure your information remains protected and
    ...
    >
      <div className="flex-1">
        ...
        <p className="text-faqAnswer font-Inter text-base font-light">
          All your data management happens directly on your device, eliminating
          the need to send sensitive information to external servers. This
          approach not only speeds up your experience but also enhances
          security. <br />
          <br />
