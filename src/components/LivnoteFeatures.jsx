...
<path fillRule="evenodd" clipRule="evenodd" d="M13.56 2H4V22H20V8.44L13.56 2ZM14 4.56L17.44 8H14V4.56ZM5.5 20.5V3.5H12.5V8.25C12.5 8.94 13.06 9.5 13.75 9.5H18.5V20.5H5.5ZM13 16H7.5V17.5H13V16ZM7.5 12.5H16.5V14H7.5V12.5Z" fill="#FCFDFF"/>
</svg>
...
const CollaborationSvg = () => {
    return (
        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fillRule="evenodd" clipRule="evenodd" d="M7 9C5.07 9 3.5 7.43 3.5 5.5C3.5 3.57 5.07 2 7 2C8.93 2 10.5 3.57 10.5 5.5C10.5 7.43 8.93 9 7 9ZM7 3.5C5.895 3.5 5 4.395 5 5.5C5 6.605 5.895 7.5 7 7.5C8.105 7.5 9 6.605 9 5.5C9 4.395 8.105 3.5 7 3.5ZM13.5 5.5C13.5 7.43 15.07 9 17 9C18.93 9 20.5 7.43 20.5 5.5C20.5 3.57 18.93 2 17 2C15.07 2 13.5 3.57 13.5 5.5ZM15 5.5C15 4.395 15.895 3.5 17 3.5C18.105 3.5 19 4.395 19 5.5C19 6.605 18.105 7.5 17 7.5C15.895 7.5 15 6.605 15 5.5ZM8.5 12.5C8.5 14.43 10.07 16 12 16C13.93 16 15.5 14.43 15.5 12.5C15.5 10.57 13.93 9 12 9C10.07 9 8.5 10.57 8.5 12.5ZM10 12.5C10 11.395 10.895 10.5 12 10.5C13.105 10.5 14 11.395 14 12.5C14 13.605 13.105 14.5 12 14.5C10.895 14.5 10 13.605 10 12.5ZM15.92 19.925L16.53 22.195V22.19L17.98 21.8L17.37 19.535C17.05 18.335 15.96 17.495 14.715 17.495H9.28502C8.04502 17.495 6.95002 18.335 6.63002 19.535L6.02002 21.805L7.47002 22.195L8.08002 19.925C8.22502 19.38 8.72002 19 9.28502 19H14.715C15.28 19 15.775 19.38 15.92 19.925ZM20.4249 12.925L21.1649 15.695L22.6149 15.305L21.8749 12.54C21.5549 11.34 20.4649 10.5 19.2199 10.5H17.0049V12H19.2199C19.7849 12 20.2799 12.38 20.4249 12.925ZM1.38477 15.305L2.83477 15.695V15.69L3.57477 12.92C3.71977 12.375 4.21477 11.995 4.77977 11.995H6.99477V10.495H4.77977C3.53977 10.495 2.44477 11.335 2.12477 12.535L1.38477 15.305Z" fill="#FCFDFF"/>
</svg>
