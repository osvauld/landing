...
export const ProtectWhatMatters = () => {
  return (
    <motion.section
      ...
      className="min-h-[45rem] lg:min-h-[55rem] w-full flex-grow flex flex-col items-center max-w-[1400px] mx-auto bg-dark4 px-4 pt-0 sm:pt-12 text-white relative"
    >
      ...
      <div className="absolute top-12 lg:top-32 left-1/2 transform -translate-x-1/2 z-10  w-full max-w-[1400px] px-4 pt-2 flex flex-col items-center ">
        ...
        <span className="pricing-content text-sm px-4 md:text-lg mb-16 text-center">
          Managing your digital life <br className="block sm:hidden" /> doesn’t
          have to be a headache.
          <br /> Forget the stress of remembering{" "}
          <br className="block sm:hidden" /> countless passwords <br /> or
        ...
        <div className="flex items-center gap-4 mt-8 pb-4 max-w-full overflow-x-scroll scrollbar-thin">
          <SpotlightCard className=" feature-card shrink-0 ">
