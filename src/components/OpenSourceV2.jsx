...
export const OpenSourceV2 = () => (
  ...
  >
    ...
    <div className="grid grid-cols-2 grid-rows-2 gap-4 h-[24rem]  text-base lg:text-xl">
      <a
        className="bg-dark5 h-[12rem] rounded-md flex flex-col gap-4 justify-center items-center text-faqAnswer  cursor-pointer col-span-2  px-2"
        target="_blank"
      ...
      <a
        className="bg-dark5 h-[12rem] rounded-md flex flex-col gap-4 justify-center items-center text-faqAnswer  cursor-pointer col-span-1 px-2"
        target="_blank"
