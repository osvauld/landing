...
export const Hero = React.memo(() => {
  ...
  return (
    ...
    >
      ...
      <div className=" z-0 w-[95%] md:w-[800px] xl:w-[1200px] flex flex-col justify-center items-start pt-16 xl:pt-10 md:pt-16 lg:pt-20 text-left ">
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        ...
        >
          <div className="text-5xl sm:text-6xl lg:text-7xl xl:text-7xl xl:tracking-[-0.2rem] tracking-[-0.15rem]  text-blue1 xl:font-normal font-normal px-0 font-Jakartha">
            <h1>
              ...
              <br />
              <span className="text-white1">Fast, Secure, and </span>{" "}
              <TextGenerateEffect
                words={"Offline!"}
        ...
        >
          <div className="text-white1 font-light text-sm sm:text-base max-w-full lg:text-base xl:text-lg xl:min-w-[30vw] xl:max-w-[55vw] mt-10 xl:mt-6 mb-4 text-left ">
            Our Peer-to-peer approach make sure you can sync credentials
            end-to-end encrypted, directly between devices—desktop or
            mobile—without a middleman.
            <br className="hidden xl:inline" />
            {/* <br className="hidden xl:inline" /> Your data, your rules:  passwords or any other
            credentials between your devices regardless of its platform. */}
          </div>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
