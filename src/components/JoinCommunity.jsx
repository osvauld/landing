...
export const JoinCommunity = () => (
  <section className="max-w-[1200px] mx-auto w-full overflow-x-hidden overflow-y-hidden h-[40rem] xs:h-[32rem] px-8 ">
    <div className="feature-card mr-auto  h-[600px] max-w-[900px] xs:h-[430px]  p-6 flex flex-col justify-start items-start  text-left overflow-hidden">
