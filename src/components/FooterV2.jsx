...
export const Footer = () => {
  return (
    <section className="w-full bg-blue1">
      <footer className="relative mx-auto h-[46rem] px-[24px] pt-[32px]  max-w-[1312px]  min-h-[545px] lg:px-[60px] lg:pt-[60px]">
        <div className="flex h-full flex-col gap-32">
          <div className="flex flex-col gap-14">
            <div className="icons flex items-center gap-10 mx-auto">
            ...
            <div className="flex flex-col xs:flex-row justify-center items-center gap-4">
              <button className="px-6 py-3 bg-black rounded-lg text-blue1 text-xl font-semibold flex items-center gap-4">
                Get Started
                <span>
